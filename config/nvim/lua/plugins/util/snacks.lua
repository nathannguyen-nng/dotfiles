return {
  ...
  ---@type snacks.Config
  opts = {
    -- animate = require("plugins.util.snacks.animate"),
    notify = { enabled = true },
    ...
    -- scroll = require("plugins.util.snacks.scroll"),
    statuscolumn = require("plugins.util.snacks.statuscolumn"),
    scope = require("plugins.util.snacks.scope"),
    ...
    -- explorer = require("plugins.util.snacks.explorer"),
  ...
  keys = {
    ...
    },
    {
      ...
      desc = "Find files contain string",
    },
    {
      "<leader>sw",
      function()
